...
<body>
    <div class="top-flex center">
        ...
        <img src="../images/logo.png" height="70" class="logo" alt="logo">
    <h2 class=center >Home page   </h2> 
    <h2 class=center > <a  class=center href="../mail/">
    Ecrire mail
  </a>
  </h2> 
    </div>
        <div class="profilenav">
            <img src="../images/girl.png" height="50" class="avatar" alt="profile picture">
  ...
  <a href="index.php?page=unseen">
    <i class="fa fa-laptop" aria-hidden="true"></i>
    Non lus
  </a>
  <a href="index.php?page=envoyer">
