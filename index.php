...
<body>
  <div class="session">
    ...
    <form  method="post" action="./access/SignIn.php" name="f">
      ...
      <p>Welcome back! Log in to your account to view your mails:</p>
      ...
      <input type="submit" class="login" name="SubmitButton" value="Login"/>

     
      <a href="inscrip.php" class="discrete" >Inscription</a>
    </form>
  </div>
</body>
</html>